...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Tambah Ruangan') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="/admin/ruangan">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="namaRuangan" type="namaRuangan" class="form-control{{ $errors->has('namaRuangan') ? ' is-invalid' : '' }}" name="namaRuangan" value="{{ old('namaRuangan') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ipComputer" type="ipComputer" class="form-control{{ $errors->has('ipComputer') ? ' is-invalid' : '' }}" name="ipComputer" value="{{ old('ipComputer') }}" required>
