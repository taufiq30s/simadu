<form action="" method="" role="form">
  <div class="modal fade" id="editDataObatModals" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="namaObat" id="namaObat" value="Nama Obat">
          </div>
          <div class="form-group">
